...
//lista de entidades a trabajar, con la base de datos
@Database(
    entities = [User::class, Expense::class, Budget::class, SharedExpense::class],
    version = 1,
    exportSchema = false
)
//generar la base de datos en el metodo abstracto
...
//un objeto compañero tener opciones estaticas para  crear una base de datos
    companion object{
        @Volatile
